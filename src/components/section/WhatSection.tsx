...
const WhatSection = () => {
    return (
        <section className="flex relative items-center justify-center mx-5">
            <div className="flex flex-col md:flex-row justify-center align-middle bg-primary w-full max-w-5xl border-1 border-secondary rounded-box p-5 md:p-7 gap-5 md:gap-7 transition duration-300 transform hover:scale-105">
