...
export async function sendPurchaseEmail({ to, name, category, amount }: PurchaseEmailParams) {
    ...
    let html = "";
    if (category === "donation") {
        subject = "Thank you for your donation to support Derby Days!";
        html = `
    <p>Hi ${name},</p>
    ...
    <p>With gratitude,<br/>Sigma Chi Epsilon Eta</p>
    `;
    } else if (category === "ad") {
    ...
    `;
        ...
        html = `
    <p>Hi ${name},</p>
    <p>Thank you for purchasing a Derby Days shirt! Your order has been received. Your shirt will be given to your team's Derby Darling when they come in.</p>
    <p>Your support helps us raise money for Valley Children’s Hospital, thanks for being part of this cause.</p>
    <p>With gratitude,<br/>Sigma Chi Epsilon Eta</p>
    `;
    }
    await resend.emails.send({
